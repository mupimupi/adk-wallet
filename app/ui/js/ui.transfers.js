    ...
    $("#transfer-btn").on("click", function (e) {
      ...
      try {
        ...
        transfer_additional_data = $("#transfer-additional-data").val().toUpperCase();
    		...
    		// adkv2, check if address is a 0x address
    		if (address.length == 42){ //0x + 40
    		...
    		// Convert a hex string to a byte array
    			...
    			if (! (found==null)) { // got a valid 0x address
    						...
    						address = aidos.utils.addChecksum(az9);
    						$("#transfer-address").val(address);
    			}
    		}
